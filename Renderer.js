Renderer = {
  render: function (data) {
    ...
    renderVerticalProgressBar(
      ...
      (w * 3) / 4,
      'Sag',
      '  ' + oneDecimal(data.vmax - data.volts),
      0,
      data.vmax - data.vmin,
      'V'
    );
    ...
    renderVerticalProgressBar(
      ...
      (w * 3) / 4,
      'Power',
      '  ' + Math.round(data.volts * data.amps),
      0,
      maxPower,
      'W'
    );
    ...
    renderHorizon(
      ...
      yc,
      w,
      w / settings.fpvAspectRatio,
      hpitch - settings.cameraAngle,
      hroll
    );
